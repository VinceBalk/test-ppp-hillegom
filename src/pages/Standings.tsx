...
export default function Standings() {
  ...
  const leftTopStandings = sortStandingsByTotal(allStandings.filter((s) => leftTop4PlayerIds.has(s.player_id))).map(
  ...
  const rightTopStandings = sortStandingsByTotal(allStandings.filter((s) => rightTop4PlayerIds.has(s.player_id))).map(
    (s, idx) => ({ ...s, position: idx + 1 }),
  );
        ...
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-center">
              R1
              <br />
              <span className="text-xs font-normal">G/S</span>
            </TableHead>
            <TableHead className="text-center">
              R2
              <br />
        ...
        <TableBody>
          {standings.map((player) => (
            <TableRow key={player.player_id}>
              <TableCell className="font-bold">{player.position === 1 ? "🥇" : player.position}</TableCell>
              <TableCell
              ...
              {chefSpecials.slice(0, 2).map((chef) => (
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <Badge variant={chef.rank_position === 1 ? "default" : "secondary"} className="text-base px-4 py-1">
                      {chef.title}
                    </Badge>
                  </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Bovenste 4 spelers (linker rij) - totaal games</CardDescription>
          </CardHeader>
          <CardContent>{renderStandingsTable(leftTopStandings)}</CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Bovenste 4 spelers (rechter rij) - totaal games</CardDescription>
          </CardHeader>
          <CardContent>{renderStandingsTable(rightTopStandings)}</CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Onderste 4 spelers (linker rij) - totaal games</CardDescription>
          </CardHeader>
          <CardContent>{renderStandingsTable(leftBottomStandings)}</CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Onderste 4 spelers (rechter rij) - totaal games</CardDescription>
          </CardHeader>
          <CardContent>{renderStandingsTable(rightBottomStandings)}</CardContent>
        </Card>
      </div>
    </div>
  );
